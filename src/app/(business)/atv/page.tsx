...
const AtvPage: FC = () => {
  ...
  return (
    <>
      ...
      <div className="w-full h-[108rem] md:h-screen relative" id="atv_section_two" ref={sectionRef}>
        {cur === 0 && <OptionsSection></OptionsSection>}
        {cur === 1 && <MechineSection></MechineSection>}
        {cur === 2 && <ProtectionSection></ProtectionSection>}
        {cur === 3 && <PadSection></PadSection>}
        {cur === 4 && <AppSection></AppSection>}
        {cur === 5 && (
          <Image
            src={'/atv_6.png'}
            alt="atv_6"
            width={1920}
            height={1080}
            className="w-full h-[108rem] md:h-screen object-fill"
          ></Image>
        )}
        {/* <Image
          src={'/atv_7.png'}
