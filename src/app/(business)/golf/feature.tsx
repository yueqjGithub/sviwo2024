...
const FeatureSection:FC = () => {
  ...
  return (
    <motion.div layout style={{ backgroundImage: "url('/golf3_bg.png')" }} className="w-full bg-white h-[108rem] relative bg-no-repeat bg-[length:100%_100%] bg-center overflow-hidden flex flex-row justify-end items-center pr-96">
      <motion.div layout className="flex flex-col justify-start items-start w-max" variants={variants}>
        <motion.div custom={0} className={`text-[#F16022] text-3xl flex flex-row justify-start items-start mb-9`} variants={variants}
        ...
        <motion.div custom={1} className={`text-[#F16022] text-3xl flex flex-row justify-start items-start mb-9`} variants={variants}
        ...
        <motion.div custom={2} className={`text-[#F16022] text-3xl flex flex-row justify-start items-start mb-9`} variants={variants}
        ...
        <motion.div custom={3} className={`text-[#F16022] text-3xl flex flex-row justify-start items-start mb-9`} variants={variants}
