export default {
  ...
  "ContactPage": { // 联系我们
    "DescTitle": "How can we help you?", // 左侧title
    "Desc": "Whether you have a question about our business or simply want to reach out and connect, this page is your gateway to getting in touch with Sviwo’s community and  team.", // 左侧文字内容
    "Email": "Email", // 邮箱
    "Message": "Message", // 消息
    "Send": "SEND" // 发送按钮
  },
  "Trip": {
    "Title": "Sorry, this product is under development" // Trip页面文字title
  },
  "Golf": { // Golf页
    // 第二屏文字内容
  ...
  "Atv": {
    "Section_1_slogan": "Cross The Land",
    "Section_1_go": "Go",
    // 参数部分
    "Section_2_name": "Name",
    "Section_2_power": "Motor Power",
    "Section_2_torque": "Torque",
    "Section_2_capacity": "Battery Capacity",
    "Section_2_speed": "Speed",
    "Section_2_wheel": "Wheel Size",
    "Section_2_grade": "Grade climbing ability",
    "Section_2_charge": "Charging time",
    "Section_2_endurance": "Endurance",
    "Section_2_protection": "Protection level",
    "Section_2_weight": "Vehicle weight",
    "Section_2_size": "Vehicle size",
    "Section_2_battery": "Battery size",
    // 两个紫色模块部分
    "Section_3_label_1": "VCU",
    "Section_3_desc_1": "Dynamic PID\r\ncontrol algorithm\r\nAdapative control\r\nalgorithm",
    "Section_3_label_2": "Controller",
    "Section_3_desc_2": "High enfficiency\r\nenergy recovery\r\nDual controller\r\nsystem",
    // 亮点页面2
    "Section_4_label": "Battery Protection",
    "Section_4_desc": "Double-layer\r\nhydraulic protection\r\n8cm impact\r\nbuffer",
    // 亮点页面3
    "Section_5_label_1": "Dual Motor system",
    "Section_5_desc_1": "2WD/4WD switching\r\n2WD≈700N·W\r\n4WD≈1400N·W",
    "Section_5_label_2": "TFT Display",
    "Section_5_desc_2": "Low Power consumption\r\nand long life\r\nHigh display quality\r\nand color accuracy",
    "Section_5_label_3": "Supension system",
    "Section_5_desc_3": "Double fork\r\nsuspension * 2",
    // APP展示部分
    "Section_6_desc_1": "1)Driving data/battery status monitoring",
    "Section_6_desc_2": "2)Drive mode switch: allows user to remotely switch between 2WD and 4WD mode",
    "Section_6_desc_3": "3)Remote control: stark/unlock/find/low speed remote control",
    "Section_6_desc_4": "4)OTA upgrade",
  }
} as const